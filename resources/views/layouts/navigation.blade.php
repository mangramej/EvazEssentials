<nav x-data="{ open: false }" class="bg-white border-b absolute border-gray-100 sticky top-0 z-50 border-b shadow">
    <livewire:side-panel>
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('welcome') }}" class="text-slate-700 font-bold">
                            {{ __('Evaz Essentials') }}
                        </a>
                    </div>
                ...
                <div class="flex justify-end">
                    <div class="flex hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <div class="shrink-0 flex items-center">
                            <button
                                class="flex justify-center text-gray-500 hover:text-gray-700 p-2 rounded transition ease"
                                onclick="Livewire.emit('openPanel', 'YOUR CART', 'cart')">
            ...
            <div class="pt-2 pb-3 space-y-1">
                <button
                    ...
                    <span class="flex">
                        ...
                        </svg> <span class="ml-2 text-sm ">Your Cart <span>
                            </span>
                </button>
